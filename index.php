...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="images/attention.jpg" width="30%" height="30%" alt="..." >
      <div class="carousel-caption">
        ...
      </div>
    </div>
    <div class="item">
      <img src="images/impnotice.jpg" width="30%" height="30%" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
...
<div class="container">
	...
	<!-- container -->
		...
		{
		echo "<h2></h2>
		<h3><font color=black><b>Welcome User.....!!</b> </h3><h4>We are here to notify you with all the latest updates...:) </h4>
		<h3><b>STAY CONNECTED STAY UPDATED...!!</b></h3> ";
		}
		?>
  ...
  <div class="panel-body" style="font-style:bold" >
	If new user click SIGNUP on the top of the page ... :)
If already existing user Please do LOGIN to get to know your notifications... :)
  </div>
</div>
...
<!-- footer-->
  ...
  <ul class="nav navbar-nav navbar-left">
    <li><a href="http://www.online_notice_board.com/"> Developed by  Bindu Kolnati</a></li>
